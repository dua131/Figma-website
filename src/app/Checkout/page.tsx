            ...
            <div className='flex justify-evenly flex-wrap px-4 md:px-0'>
                <div className='flex gap-x-4 items-center'>
                    <div>
                        ...
                        <div>
                            <span className='text-sm text-gray-700 px-2 '>{'Mens'} Short-Sleeve </span> <br />
                            <span className='text-sm text-gray-700 px-2 '>Running Top</span>
                        </div>
                    </div>
                    <div>
                        <div className='flex items-center justify-end pr-10 mb-2'>
                            <span className='text-xs sm:text-sm w-20'>Shop {'Mens'}</span>
                        ...
                        <div>
                            ...
                            <span className='text-sm text-gray-700 px-2 '>{'Mens'} 18cm (approx.) 2</span> <br />
                ...
                <div className='flex gap-x-4'>
                    <div>
                        ...
                        <div>
                                ...
                                <span className='text-sm text-gray-700 px-2 '>{'Womens'} Long-Sleeve </span> <br />
                            <span className='text-sm text-gray-700 px-2 '>Running Top</span>
                    ...
                    <div>
                        <div className='flex items-center justify-end  pr-10 mb-2 '>
                            <span className='text-xs sm:text-sm w-28'>Shop {'Womens'}</span>
                            <div className='p-2 bg-gray-100 text-zinc-400 rounded-full hover:bg-gray-200 hover:text-zinc-800 mx-1 md:mx-3'>
                                <ChevronLeft />
                            </div>
                            <div className='p-2 bg-gray-100 text-zinc-400 rounded-full hover:bg-gray-200 hover:text-zinc-800'>
                        ...
                        <div>
                            <span className='text-sm text-gray-700 px-2 '>{'Womens'} Mid-Rise 7/8 Running </span> <br />
